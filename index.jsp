...
<body>
        ...
        <nav class="navbar navbar-light navbar-expand-lg bg-primary shadow-sm">
            <div class="container-fluid">
                ...
                <div class="d-flex ms-auto">
                    <a href="#" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#SalirModal">Salir</a>
                </div>
            </div>
            <!-- Modal -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="confirmSalir">Salir</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="usuarios.jsp" class="btn btn-primary">Ir a Usuarios</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="nuevoProducto.jsp" class="btn btn-primary">Añadir Productos</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.getElementById('confirmSalir').addEventListener('click', function () {
            window.location.href = 'inicio.jsp'; // Redirigir a inicio.jsp al confirmar salir
        });
    </script>
</body>
