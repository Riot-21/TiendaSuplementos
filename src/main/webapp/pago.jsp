                    ...
                    <div class="card shadow-sm p-4">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="apellido" value="Perez" readonly>
                            </div>
                            <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm p-4">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                <strong>Subtotal:</strong> <span>S/. 100.00</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <strong>Envío:</strong> <span>S/. 10.00</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <strong>Total:</strong> <span>S/. 118.00</span>
                            </li>
                        </ul>
                        <button class="btn btn-primary w-100 mt-4" id="comprarBtn">Confirmar Compra</button>
                    </div>
                </div>
            </div>
        </div>
